                    ...
                    <form method="post" action="{{ route('tambah_laporan') }}" enctype="multipart/form-data">
                        ...
                        <fieldset class="row mb-3 mt-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status_terlapor" id="pendidik"
                                        value="Pendidik">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status_terlapor"
                                        id="wargaKampus" value="Warga Kampus">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status_terlapor"
                                        id="masyarakatUmum" value="Masyarakat Umum">
                            ...
                            <div class="border border-light p-3">
                                <div class="mb-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="alasan_pengaduan[]"
                                            id="korban" value="Saya seorang korban yang memerlukan bantuan pemulihan">
